...
SEED_USER="${SEED_USER:-TEST_USER}"
SEED_PASS="${SEED_PASS:-test_pass}"

# Scale factors
NUM_EMPLOYEES="${NUM_EMPLOYEES:-40000}"
NUM_PROJECTS="${NUM_PROJECTS:-12000}"
NUM_DEPARTMENTS="${NUM_DEPARTMENTS:-6000}"
NUM_PRODUCTS="${NUM_PRODUCTS:-30000}"
NUM_CUSTOMERS="${NUM_CUSTOMERS:-40000}"
NUM_ORDERS="${NUM_ORDERS:-12000}"
MAX_ITEMS_PER_ORDER="${MAX_ITEMS_PER_ORDER:-500}"
